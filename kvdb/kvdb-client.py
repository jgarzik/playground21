...
#
# Command line usage:
# $ python3 kvdb-client.py		# Get service info (JSON)
# $ python3 kvdb-client.py KEY		# Get value from server, given KEY
# $ python3 kvdb-client.py KEY VALUE	# Store KEY and VALUE on server
#
